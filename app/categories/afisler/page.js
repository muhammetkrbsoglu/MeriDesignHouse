...
export const metadata = {
  title: "Afişler - El Yapımı Hediyeler",
  description: "Doğum günü partileriniz için özel tasarım afişler",
}

export default async function AfislerPage() {
    ...
    <div className="min-h-screen bg-neutral-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-neutral-800 mb-4">Afişler</h1>
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto mb-8">
            Doğum günü partileriniz için özel tasarım afişler ve pankartlar
          </p>
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-gray-500 md:ml-2">Afişler</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              Özel tasarım afişler hazırlanıyor. Çok yakında sizlerle buluşacak olan renkli pankartlarımızı kaçırmayın!
            </p>
